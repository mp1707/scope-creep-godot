...
Beim Draggen fragt die Presentation die Simulation nach allen aktuell gueltigen Drop-Zielen. Passende Board- und Shop-Stacks werden waehrend des Drags mit einer animierten gestrichelten Umrandung in der dunklen Haupt-Textfarbe markiert; die Striche haben runde Caps und an den Ecken bewusst kleine Luecken gegen Ueberlappungsartefakte. Die Preview zeigt nur Drops, die nach aktueller Phase, Stack-Inhalt, Mengen und Processing-Zustand wirklich ausfuehrbar sind; theoretische Spaeter-Kombinationen werden nicht markiert.
